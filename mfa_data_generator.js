...
function formatAsCSV(record) {
    ...
    return [
        ...
        escapeCSV(record.APP_RISK_LEVEL),
        escapeCSV(formatBoolean(record.APP_MFA_REQUIRED))
    ].join(',');
}
...
function formatAsTSV(record) {
    ...
    return [
        ...
        escapeTSV(record.APP_RISK_LEVEL),
        escapeTSV(formatBoolean(record.APP_MFA_REQUIRED))
    ].join('\t');
}
